...
class PPOAgent:
    ...
    def compute_kl_mean(self, old_mu_batch, old_std_batch, mu_batch, std_batch):
        ...
        log_ratio = torch.log(std_batch / old_std_batch)
            
        numerator = old_std_batch**2 + (old_mu_batch - mu_batch)**2
        denominator = 2.0 * std_batch**2
            

        kl_per_dim = log_ratio + (numerator / denominator) - 0.5
    ...
    def compute_entropy_loss(self, entropy_batch):
        ...
        return -entropy_batch.mean() * self.entropy_coeff
